...
- [ergut/mcp-bigquery-serve](https://github.com/ergut/mcp-bigquery-server)  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg" width="16" height="16"/> ☁️ - Second (But with Python) BigQuery database integration with schema inspection and query capabilities
