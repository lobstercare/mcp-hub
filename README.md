...
- [commune-sh/commune-mcp](https://github.com/commune-sh/commune-mcp) <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg" width="16" height="16"/> ☁️ - Agent email infrastructure — provision inboxes, send/receive email, manage threads, custom domains, attachments, structured extraction, and SMS
